module supervlabs::svl_inventory {
    ...
    fun init_module(package: &signer) {
        let class_address = orm_class::update_class_as_collection<SvlInventory>(
            package,
    ...
    entry fun update_module(user: &signer) {
        let (orm_creator, _) = orm_module::get<SvlInventory>(@supervlabs);
    ...
    fun create_rg_object(
        ...
        orm_object::init_properties(&ref, vector[], vector[], vector[]);
