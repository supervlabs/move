/// This module provides the preset of items generated by Supervlabs Gacha system.
/// The gacha items registered by this module are sorted by group name and index and used in Gacha.
module supervlabs::gacha_item {
    ...
    fun update_object<T: key>(
        ...
        let object_signer = orm_object::load_signer(package_owner, object);
    ...
    entry fun create(
        ...
        create_object(package_owner, group, index, name, uri, description, property_keys, property_types, property_values, option::none());
    }
    ...
    entry fun create_to(
        ...
        create_object(package_owner, group, index, name, uri, description, property_keys, property_types, property_values, option::some(to));
    }
    ...
    entry fun update(
        ...
        update_object(package_owner, obj, name, uri, description, property_keys, property_types, property_values);
    }
    ...
    #[test_only]
    public fun test_init_module(package_owner: &signer, package: &signer) acquires GachaItemGroup {
        use std::vector;
        init_module(package);
        create_object(
            package_owner,
            string::utf8(b"sidekick/legendary"),
            0,
            string::utf8(b"butcher"),
            string::utf8(b"uri://butcher.sidekick"),
            string::utf8(b"butcher desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/legendary"),
            1,
            string::utf8(b"woodman"),
            string::utf8(b"uri://woodman.sidekick"),
            string::utf8(b"woodman desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/epic"),
            0,
            string::utf8(b"king"),
            string::utf8(b"uri://king.sidekick"),
            string::utf8(b"king desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/epic"),
            1,
            string::utf8(b"queen"),
            string::utf8(b"uri://queen.sidekick"),
            string::utf8(b"queen desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/rare"),
            0,
            string::utf8(b"prince"),
            string::utf8(b"uri://prince.sidekick"),
            string::utf8(b"prince desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/rare"),
            1,
            string::utf8(b"princess"),
            string::utf8(b"uri://princess.sidekick"),
            string::utf8(b"princess desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/uncommon"),
            0,
            string::utf8(b"walker"),
            string::utf8(b"uri://walker.sidekick"),
            string::utf8(b"walker desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/uncommon"),
            1,
            string::utf8(b"runner"),
            string::utf8(b"uri://runner.sidekick"),
            string::utf8(b"runner desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/common"),
            0,
            string::utf8(b"fool"),
            string::utf8(b"uri://fool.sidekick"),
            string::utf8(b"fool desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
        create_object(
            package_owner,
            string::utf8(b"sidekick/common"),
            1,
            string::utf8(b"xxx"),
            string::utf8(b"uri://xxx.sidekick"),
            string::utf8(b"xxx desc"),
            vector::empty(), vector::empty(), vector::empty(), option::none());
    }
}